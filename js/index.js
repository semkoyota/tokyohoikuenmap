...
// Google Maps APIのキー（取得が必要）
var google_maps_api_key = "AIzaSyBWjDpKdNRSpo-ZpYHfifexanfUMzKnZi4";
...
var mapServerList = {
  "google-roadmap": {
    ...
    source: new ol.source.XYZ({
      ...
      attributions: [
        new ol.Attribution({
          html: "&copy; <a href='https://www.google.com/maps' target='_blank'>Google Maps</a>",
        }),
      ],
    }),
  },
  ...
  "bing-road": {
    ...
    source: new ol.source.BingMaps({
      culture: "ja-jp",
      key: "Ap-kk3eox-rGrZ07nFRNVGWy6BlbbkhXeXi-TwvOuIcltcoLsuEsEoBEWmVTWHOe",
      imagerySet: "Road",
    }),
  },
  osm: {
    ...
    source: new ol.source.OSM({
      ...
      attributions: [
        ...
        new ol.Attribution({
          html: "Tiles courtesy of <a href='http://www.thunderforest.com/' target='_blank'>Andy Allan</a>",
        }),
      ],
    }),
  },
...
$("#mainPage").on("pageshow", function () {
  ...
  papamamap.generate(mapServerList["google-hybrid"]);
  map = papamamap.map;

  // 保育施設の読み込みとレイヤーの追加
  papamamap
    .loadNurseryFacilitiesJson(function (data) {
  ...
  map.on("click", function (evt) {
    ...
    // クリック位置の施設情報を取得
    obj = map.forEachFeatureAtPixel(evt.pixel, function (feature, layer) {
    ...
    if (feature && layer.get("name") === "layerCircle" && feature.getGeometry().getType() === "Polygon") {
  ...
  $("#changeBaseMap").change(function (evt) {
    ...
    papamamap.changeMapServer(mapServerList[$(this).val()], $("#changeOpacity option:selected").val());
  });
